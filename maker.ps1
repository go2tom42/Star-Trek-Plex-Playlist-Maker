...
function play50 {
    ...
    for ($i = 1; $i -le $numplaylists; $i++) {
        "Creating playlist $i of $numplaylists"
    ...
    for ($i = 0; $i -lt $Results.count; $i++) {
        switch ($i) {
            { $_ -gt 0 -and $_ -le 50 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 1" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($01Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 50 -and $_ -le 100 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 2" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($02Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 100 -and $_ -le 150 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 3" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($03Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 150 -and $_ -le 200 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 4" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($04Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 200 -and $_ -le 250 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 5" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($05Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 250 -and $_ -le 300 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 6" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($06Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 300 -and $_ -le 350 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 7" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($07Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 350 -and $_ -le 400 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 8" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($08Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 400 -and $_ -le 450 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 9" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($09Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 450 -and $_ -le 500 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 10" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($10Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 500 -and $_ -le 550 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 11" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($11Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 550 -and $_ -le 600 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 12" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($12Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 600 -and $_ -le 650 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 13" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($13Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 650 -and $_ -le 700 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 14" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($14Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 700 -and $_ -le 750 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 15" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($15Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 750 -and $_ -le 800 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 16" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($16Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 800 -and $_ -le 850 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 17" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($17Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 850 -and $_ -le 900 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 18" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($18Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
        }
    }    
}
...
function play100 {
    ...
    for ($i = 0; $i -lt $Results.count; $i++) {
        switch ($i) {
            { $_ -gt 0 -and $_ -le 100 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 1" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($01Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 100 -and $_ -le 200 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 2" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($02Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 200 -and $_ -le 300 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 3" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($03Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 300 -and $_ -le 400 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 4" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($04Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 400 -and $_ -le 500 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 5" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($05Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 500 -and $_ -le 600 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 6" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($06Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 600 -and $_ -le 700 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 7" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($07Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 700 -and $_ -le 800 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 8" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($08Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
            { $_ -gt 800 -and $_ -le 900 } { $quick = $Results.count - 1; "$i of $quick"; $PlaylistID = (get-plexplaylist | Where-Object { $_.title -eq "Star Trek Chrono 9" }).ratingKey; $Data = Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/library/metadata/$($PlaylistID)/posters?url=$([uri]::EscapeDataString($09Poster))&X-Plex-Token=$($DefaultPlexServer.Token)" -Method "POST"; $ItemID = $Results[$i].PlexID; $RestEndpoint = "playlists/$PlaylistID/items?uri=server://$($CurrentPlexServer.machineIdentifier)/com.plexapp.plugins.library/library/metadata/$ItemID" ; Invoke-RestMethod -Uri "$($DefaultPlexServer.Protocol)`://$($DefaultPlexServer.PlexServerHostname)`:$($DefaultPlexServer.Port)/$RestEndpoint`?&X-Plex-Token=$($DefaultPlexServer.Token)" -Method PUT -ErrorAction Stop | Out-Null ; Start-Sleep -Seconds 1 }
        }
    }    
}
